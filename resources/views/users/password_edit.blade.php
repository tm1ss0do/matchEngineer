...
<h3 class="c-title--page u-text-align--center">パスワード変更</h3>
...
<div class="p-form__container u-flex u-flex--center">
  ...
  <form class="p-form__form--midi js-form" method="POST" action="">
    ...
    <section class="c-input__line">
      <label class="c-title--label" for="current-password">現在のパスワード</label></br>
    ...
    <section class="c-input__line">
      <label class="c-title--label" for="new-password">新しいパスワード</label></br>
    ...
    <section class="c-input__line">
      <label class="c-title--label" for="confirm">新しいパスワード（確認用）</label></br>
